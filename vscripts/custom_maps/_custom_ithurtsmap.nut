...
void function ithurtsmap_player_setup( entity player )
{
	...
	Message(player, "Welcome to the It Hurts Map!", "Made by LoyTakian.")

	thread ithurtsmap_SpawnInfoText( player )
}

void function ithurtsmap_load() {
    // Props
    entity prop
    ...
    // Buttons
    AddCallback_OnUseEntity( CreateFRButton(< 29890.02, -1092.1, 50058.9 >, < 0, -179.9997, 0 >, "%use% Start/Stop Timer"), void function(entity panel, entity ent, int input)
    {
