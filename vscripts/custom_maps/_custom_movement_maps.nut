...
function MovementGym_Hub_Buttons() {
  // Props
  MapEditor_CreateProp($"mdl/barriers/shooting_range_target_02.rmdl", < 10954, 9688.609, -4222 > , < 0, -179.9993, 0 > , true, 5000, -1, 0.62878)
  ...
  // Buttons
  AddCallback_OnUseEntity(CreateFRButton( < 10942.45, 9688.609, -4296.652 > , < 0, -89.9994, 0 > , "%use% Map 2 by DEAFPS"), void
    function (entity panel, entity user, int input) {
      EmitSoundOnEntityOnlyToPlayer(user, user, FIRINGRANGE_BUTTON_SOUND)
  ...
  AddCallback_OnUseEntity(CreateFRButton( < 10942.45, 9776.609, -4296.651 > , < 0, -89.9994, 0 > , "%use% Treerees Movement Map 1"), void
    function (entity panel, entity user, int input) {
      EmitSoundOnEntityOnlyToPlayer(user, user, FIRINGRANGE_BUTTON_SOUND)
  ...
  AddCallback_OnUseEntity(CreateFRButton( < 10942.46, 10085.11, -4296.651 > , < 0, -90.0001, 0 > , "%use% TTV Building 2"), void
    function (entity panel, entity user, int input) {
      EmitSoundOnEntityOnlyToPlayer(user, user, FIRINGRANGE_BUTTON_SOUND)
  ...
  AddCallback_OnUseEntity(CreateFRButton( < 10942.46, 10168.11, -4296.651 > , < 0, -90.0001, 0 > , "%use% TTV Building 1"), void
    function (entity panel, entity user, int input) {
      EmitSoundOnEntityOnlyToPlayer(user, user, FIRINGRANGE_BUTTON_SOUND)
  ...
  AddCallback_OnUseEntity(CreateFRButton( < 10942.45, 10005.11, -4296.651 > , < 0, -90.0001, 0 > , "%use% Skyhook TTV"), void
    function (entity panel, entity user, int input) {
      EmitSoundOnEntityOnlyToPlayer(user, user, FIRINGRANGE_BUTTON_SOUND)
  ...
  AddCallback_OnUseEntity(CreateFRButton( < 10534.2, 9907.363, -4296.651 > , < 0, 90.0002, 0 > , "%use% Pathfinder Grapples WIP"), void
    function (entity panel, entity user, int input) {
      EmitSoundOnEntityOnlyToPlayer(user, user, FIRINGRANGE_BUTTON_SOUND)
  ...
  AddCallback_OnUseEntity(CreateFRButton( < 10487.06, 9703.41, -4265.34 > , < 0.0003, -89.9997, -90.0002 > , "%use% Change Melee"), void
    function (entity panel, entity user, int input) {
      EmitSoundOnEntityOnlyToPlayer(user, user, FIRINGRANGE_BUTTON_SOUND)
...
function MovementGym_Hub_Melee() {
  ...
  // Buttons
  AddCallback_OnUseEntity(CreateFRButton( < 10886.39, 9949.203, -3758.34 > , < 0.0003, 90, -90.0002 > , "%use% Get Shadow Hands"), void
    function (entity panel, entity user, int input) {
      EmitSoundOnEntityOnlyToPlayer(user, user, FIRINGRANGE_BUTTON_SOUND)
      user.SetPlayerNetBool("pingEnabled", false)
  ...
  AddCallback_OnUseEntity(CreateFRButton( < 10886.4, 10097.2, -3758.34 > , < 0.0003, 90, -90.0002 > , "%use% Get Empty Hands"), void
    function (entity panel, entity user, int input) {
      EmitSoundOnEntityOnlyToPlayer(user, user, FIRINGRANGE_BUTTON_SOUND)
      user.SetPlayerNetBool("pingEnabled", false)
  ...
  AddCallback_OnUseEntity(CreateFRButton( < 10886.39, 10022.7, -3758.34 > , < 0.0003, 90, -90.0002 > , "%use% Get Wattson Hands"), void
    function (entity panel, entity user, int input) {
      EmitSoundOnEntityOnlyToPlayer(user, user, FIRINGRANGE_BUTTON_SOUND)
      user.SetPlayerNetBool("pingEnabled", false)
      Message(user, "You have now Sparky Hands")
  ...
  AddCallback_OnUseEntity(CreateFRButton( < 10506.83, 9923.104, -3758.34 > , < 0.0003, -89.9997, -90.0002 > , "%use% Back to Hub"), void
    function (entity panel, entity user, int input) {
      EmitSoundOnEntityOnlyToPlayer(user, user, FIRINGRANGE_BUTTON_SOUND)
      TeleportFRPlayer(user, < 10646, 9925, -4283 > , < 0, -89.9998, 0 > )
      Message(user, "Hub")
...
function MovementGym_Map1() {
  ...
  MapEditor_CreateProp($"mdl/desertlands/industrial_cargo_container_320_01.rmdl", < 3701.001, 4159, -761.7496 > , < 0, 0, 0 > , true, 5000, -1, 1)
  ...
  MapEditor_CreateProp($"mdl/desertlands/industrial_cargo_container_320_01.rmdl", < 3701.001, 4159, -634.3495 > , < 0, 0, 0 > , true, 5000, -1, 1)
  ...
  MapEditor_CreateProp($"mdl/desertlands/city_pipe_grate_medium_128.rmdl", < 3391.04, 3417.89, -712.999 > , < 0, -90, 0 > , true, 5000, -1, 1)
  ...
  MapEditor_CreateProp($"mdl/thunderdome/thunderdome_cage_ceiling_256x256_05.rmdl", < 3392.58, 3712.07, -704.813 > , < 0, 90, 0 > , true, 5000, -1, 1)
  ...
  MapEditor_CreateProp($"mdl/desertlands/desrtlands_icicles_06.rmdl", < 3455.22, 3648.58, -715.7458 > , < 0, -90, 0 > , true, 5000, -1, 1)
  ...
  MapEditor_CreateProp($"mdl/desertlands/city_pipe_grate_medium_128.rmdl", < 3391.039, 3417.89, -705.0012 > , < 0, -90, 179.9997 > , true, 5000, -1, 1)
  ...
  MapEditor_CreateProp($"mdl/desertlands/city_pipe_grate_medium_128.rmdl", < 3391.039, 3546.11, -704.6152 > , < 0, -90, 179.9997 > , true, 5000, -1, 1)
  ...
  MapEditor_CreateProp($"mdl/desertlands/industrial_cargo_container_320_01.rmdl", < 3701.001, 4159, -889.2496 > , < 0, 0, 0 > , true, 5000, -1, 1)
  ...
  MapEditor_CreateProp($"mdl/desertlands/desrtlands_icicles_06.rmdl", < 3327.18, 3648.49, -715.6808 > , < 0, -90, 0 > , true, 5000, -1, 1)
  ...
  MapEditor_CreateProp($"mdl/desertlands/industrial_cargo_container_320_01.rmdl", < 3701.001, 4159, -1016.35 > , < 0, 0, 0 > , true, 5000, -1, 1)
  ...
  MapEditor_CreateProp($"mdl/desertlands/city_pipe_grate_medium_128.rmdl", < 3391.04, 3546.11, -713.385 > , < 0, -90, 0 > , true, 5000, -1, 1)
  ...
  MapEditor_CreateProp($"mdl/desertlands/industrial_cargo_container_320_01.rmdl", < 3701.001, 4159, -507.0496 > , < 0, 0, 0 > , true, 5000, -1, 1)
  ...
  MapEditor_CreateProp($"mdl/desertlands/industrial_cargo_container_320_01.rmdl", < 3701.001, 4159, -379.6495 > , < 0, 0, 0 > , true, 5000, -1, 1)
  ...
  MapEditor_CreateProp($"mdl/desertlands/desrtlands_icicles_06.rmdl", < 3391.25, 3648.56, -715.6378 > , < 0, -90, 0 > , true, 5000, -1, 1)
...
function MovementGym_Map2() {
  ...
  NoClimbArray.append(MapEditor_CreateProp($"mdl/barriers/shooting_range_target_02.rmdl", < 29469.7, -20272.5, 23084.2 > , < 0, 179.9997, 0 > , true, 5000, -1, 1))
...
function MovementGym_Octane() {
  ...
  ClipArray.append(MapEditor_CreateProp($"mdl/ola/sewer_railing_01_128.rmdl", < 13192.28, -830.6016, 22431.1 > , < 0, 179.9998, 0 > , true, 5000, -1, 1))
  ClipArray.append(MapEditor_CreateProp($"mdl/ola/sewer_railing_01_128.rmdl", < 13451.2, -102.8984, 22430.8 > , < 0, -0.0005, 0 > , true, 5000, -1, 1))
  ...
  ClipArray.append(MapEditor_CreateProp($"mdl/thunderdome/thunderdome_cage_ceiling_256x256_06.rmdl", <