...
1. There are two modes of the gungame gamemode in the folder, you have to choose one.

2. Make a backup of your previous _gamemode_custom_tdm.nut file and rename the gungame file selected.

4. In your custom_tdm section in the playlist,  this is playlists_r5_patch.txt in platform folderm, you can put a secondary weapon this way:
...
3.  In your custom_tdm section in the playlist add this as well:
