...
void function OpenFRChallengesSettingsWpnSelector()
{
	...
	Hud_SetText( Hud_GetChild( file.menu, "MadeBy" ), Gamemode() == eGamemodes.WINTEREXPRESS ? "R5R Winter Express by %$rui/flowstate_custom/colombia_flag_papa% Flowstate" : "v1.31 | %$rui/flowstate_custom/colombia_flag_papa% Made in Colombia by @CafeFPS" )
