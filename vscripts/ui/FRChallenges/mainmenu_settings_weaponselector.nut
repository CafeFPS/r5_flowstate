...
void function OpenFRChallengesSettingsWpnSelector()
{
	...
	Hud_SetText( Hud_GetChild( file.menu, "MadeBy" ), Gamemode() == eGamemodes.WINTEREXPRESS ? "%$rui/flowstate_custom/colombia_flag_papa% Ported by @CafeFPS" : "v1.31 | %$rui/flowstate_custom/colombia_flag_papa% Made in Colombia by @CafeFPS" )
