...
void function CollectionEventPanel_UpdateGRXDependantElements() // TODO: IMPLEMENT
{
	...
	// 	HudElem_SetRuiArg( file.heirloomBox, "unlockDesc", CollectionEvent_GetHeirloomUnlockDesc( activeCollectionEvent ) )
...
void function UpdateFocusStuff( var focusedRewardButtonOrNull ) // TODO: IMPLEMENT
{
	// //
...
//
void function TryPreviewIncludedQuip( ItemFlavor rewardFlav ) // TODO: IMPLEMENT
{
	// if ( playingQuipEventName != "" )
	// {
	// 	StopUISoundByName( playingQuipEventName )
...
void function RewardButton_OnAltActivate( var btn ) // TODO: IMPLEMENT
{
	// if ( !Hud_IsEnabled( btn ) )
	// 	return
...
void function HeirloomBox_OnClick( var btn ) // TODO: IMPLEMENT
{
	// ItemFlavor activeCollectionEvent = expect ItemFlavor(file.activeCollectionEvent)
...
void function OpenPackButton_OnClick( var btn ) // TODO: IMPLEMENT
{
	// if ( Hud_IsLocked( btn ) )
	// 	return
