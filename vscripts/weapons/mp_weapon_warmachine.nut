...
global function OnWeaponPrimaryAttack_weapon_warmachine
global function OnProjectileCollision_weapon_warmachine

#if SERVER
global function OnWeaponNpcPrimaryAttack_weapon_warmachine
#endif // #if SERVER
...
var function OnWeaponPrimaryAttack_weapon_warmachine( entity weapon, WeaponPrimaryAttackParams attackParams )
{
...
#if SERVER
var function OnWeaponNpcPrimaryAttack_weapon_warmachine( entity weapon, WeaponPrimaryAttackParams attackParams )
{
	PrecacheParticleSystem( SOFTBALL_PROJECTILE_IMP )
	weapon.EmitWeaponNpcSound( LOUD_WEAPON_AI_SOUND_RADIUS_MP, 0.2 )
...
void function OnProjectileCollision_weapon_warmachine( entity projectile, vector pos, vector normal, entity hitEnt, int hitbox, bool isCritical )
{
	entity fx
	#if SERVER
	...
	#endif
	int particleSystemIndex = GetParticleSystemIndex( SOFTBALL_PROJECTILE_IMP )
	...
	if ( !didStick )
		...
		if ( IsAlive( hitEnt ) && hitEnt.IsPlayer() )
		{
			...
			EmitSoundOnEntity( projectile, "weapon_vortex_gun_explosivewarningbeep" )
		}
		else
		{
